    ...
    <div class="col-2 px-0 sidebar sidebar-collapse pt-2 d-flex flex-column h-100">
        ...
        <div class="px-3">
            ...
            <nav class="mt-4">
                ...
                <?php if ($_SESSION["user"]['role'] !== 'organismo_externo'): ?>
                    <h6><?= htmlspecialchars($_SESSION["user"]['firstname'] . ' ' . $_SESSION["user"]['lastname'], ENT_QUOTES, 'UTF-8'); ?>
                    <?php else: ?>
                        <h6><?= htmlspecialchars($_SESSION["user"]['empresa'], ENT_QUOTES, 'UTF-8'); ?>
                            <h6><?= htmlspecialchars($_SESSION["user"]['nombre_contacto'], ENT_QUOTES, 'UTF-8'); ?>
                            <?php endif ?>
                        </h6>
                        ...
                        <?php elseif ($_SESSION["user"]['role'] === 'organismo_externo'): ?>
                        ...
                        <div class="row schools" style="padding-right: 0 !important;">
                            ...
                            <?php if ($role === 'admin'): ?>
                                <div class="dropdown mt-1">
                                    <button class="btn menu-top dropdown-toggle w-100" type="button" id="adminMenuButton"
                                    ...
                                    <ul class="dropdown-menu w-100" aria-labelledby="adminMenuButton">
                                        ...
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('courses', $pagina) ?>"
                                                href="courses">
                                                <i class="fad fa-school me-2"></i> Ciclo escolar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('degrees', $pagina) ?>"
                                                href="degrees">
                                        ...
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('students', $pagina) ?>"
                                                href="students">
                                ...
                                <div class="dropdown mt-1">
                                    ...
                                    <ul class="dropdown-menu w-100" aria-labelledby="internshipMenuButton">
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('internship_companies', $pagina) ?>"
                                                href="internship_companies">
                                                <i class="fa-duotone fa-building me-2"></i> Organismos receptores
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('internship_students', $pagina) ?>"
                                                href="internship_students">
                                                <i class="fa-duotone fa-user-tie me-2"></i> Estudiantes
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item <?= setActiveClass('internship_events', $pagina) ?>"
                                                href="internship_events">
        ...
        <div class="px-3 mt-auto">
            ...
            <ul class="navbar-nav w-100">
                <li class="d-grid gap-2">
                    ...
                    <?php else: ?>
                        <button class="btn-logout mt-3 py-2" onclick="logout('externo')">
                    <?php endif ?>
